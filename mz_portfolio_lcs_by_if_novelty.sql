-- DROP TABLE IF EXiSTS tutorial.mz_portfolio_lcs_by_if_novelty;
-- CREATE TABLE tutorial.mz_portfolio_lcs_by_if_novelty AS
...
sales_plan_table AS (
SELECT CASE WHEN cn_lcs_launch_date >= '2024-12-25' THEN 'novelty' ELSE 'existing' END AS if_novelty,
...
ttl_sales_TY AS (
SELECT CASE WHEN bu_cn_launch_date >= '2024-12-25' THEN 'novelty' ELSE 'existing' END                           AS if_novelty,
...
grant select on tutorial.mz_portfolio_lcs_by_if_novelty to lego_bi_group;
