-- DROP TABLE IF EXiSTS tutorial.mz_portfolio_lcs_by_price_range;
-- CREATE TABLE tutorial.mz_portfolio_lcs_by_price_range AS

delete from tutorial.mz_portfolio_lcs_by_price_range;  -- for the subsequent update
insert into tutorial.mz_portfolio_lcs_by_price_range
...
sales_plan_table AS (
SELECT product_rrp_price_range,
...
ttl_sales_TY AS (
SELECT product_cte.product_rrp_price_range,
...
sales AS ( 
SELECT ttl_sales_TY.product_rrp_price_range,
...
grant select on tutorial.mz_portfolio_lcs_by_price_range to lego_bi_group;
